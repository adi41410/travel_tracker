  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer4<AuthProvider, TripProvider, MemoryProvider, PointsProvider>(
        builder: (context, authProvider, tripProvider, memoryProvider, pointsProvider, child) {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildProfileItem('Home City', user.homeCity, Icons.home),
                      if (user.email != null) 
                        _buildProfileItem('Email', user.email!, Icons.email),
                      if (user.phone != null) 
                        _buildProfileItem('Phone', user.phone!, Icons.phone),
                      _buildProfileItem('Currency', user.preferredCurrency, Icons.attach_money),
                      _buildProfileItem(
                        'Account Type', 
